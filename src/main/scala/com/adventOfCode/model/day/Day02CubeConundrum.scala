...
object Day02CubeConundrum extends RenderMethods {
  ...
  /** You're launched high into the atmosphere! The apex of your trajectory just barely reaches the
    ...
    *
    * Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green Game 2: 1 blue, 2 green; 3 green, 4
    * blue, 1 red; 1 green, 1 blue Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5
    * green, 1 red Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red Game 5:
  ...
  override def calculate_part_one(input: Array[String]): Option[Int] = {
    Some(Day02Impl.sumRounds(input))
  }
  ...
  /** The Elf says they've stopped producing snow because they aren't getting any water! He isn't
    ...
    * any color had even one fewer cube, the game would have been impossible. Game 2 could have been
    * played with a minimum of 1 red, 3 green, and 4 blue cubes. Game 3 must have been played with
    * at least 20 red, 13 green, and 6 blue cubes. Game 4 required at least 14 red, 3 green, and 15
    * blue cubes. Game 5 needed no fewer than 6 red, 3 green, and 2 blue cubes in the bag.
    *
  ...
  override def calculate_part_two(input: Array[String]): Option[Int] = {
    Some(Day02Impl.computeGamePower(input))
  }
